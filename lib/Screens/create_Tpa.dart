...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const CreateTPA(),
    );
  }
}

class CreateTPA extends StatelessWidget {
  const CreateTPA({super.key});
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text('Test Parameters',style: TextStyle(color: Colors.red[800],fontSize: 15,fontWeight: FontWeight.bold),),
          SizedBox(height: 10,),
          TextField(
          ...
          Row(
            ...
            children: [
              ...
              }, style: ElevatedButton.styleFrom(primary: Colors.red[800]),  label: Text('Ok'),icon: Icon(Icons.check,color: Colors.green,),),
              SizedBox(width: 20,),
